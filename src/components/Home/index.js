...
function HomeV2() {
  ...
  useEffect(() => {
    const initialize = async () => {
      ...
      const account = new Account(
        'skywalker',
        process.env.NEXT_PUBLIC_USER_ADDR,
      );
      await account.init();
      account.print();
  ...
  const updateBalances = async (account) => {
    ...
    // console.log(
    //   "mangataHelper.getBalance('MGR-TUR', mangataAddress)",
    //   await mangataHelper.getBalance('MGR-TUR', mangataAddress),
    // );
  ...
  const turFreeBalance = turBalance
    ? turBalance.free.div(new BN(TUR_DECIMAL)).toString()
    : 0;
  const mgrFreeBalance = mgrBalance
    ? mgrBalance.free.div(new BN(MGR_DECIMAL)).toString()
    : 0;
  const liquidityTokenFreeBalance = liquidityTokenBalance
    ? liquidityTokenBalance.reserved.div(new BN(MGR_DECIMAL)).toString()
    : 0;
      ...
      <div className="sider">
        <Container>
          ...
          <div className="flex" style={{ padding: '0 18px' }}>
            ...
            <div className="flex-grow-10">
              <div
                ...
                fontSize="14"
                letterSpacing="0.4"
                data-testid="connect-accountName"
                className="sc-dkzDqf cjllyR"
              >
                TUR-MGX Bootstrap
              </div>
              <div
                ...
                fontSize="14"
                letterSpacing="0.4"
                data-testid="connect-accountAddress"
                className="sc-dkzDqf gqqtbp"
              >
                5FgWx...km7bF
              </div>
            </div>
          ...
          <Row className="border-bottom">
            ...
            <Button className="flex-grow-1" type="default">
              WITHDRAW
            </Button>
          </Row>
          <Row className="border-bottom">
            ...
            <div className="flex" style={{ width: '100%' }}>
              ...
              <div className="flex-grow-1 liquidity-balance">
                <div
                ...
                <div color="currentColor" className="inline-block">
                  {`${liquidityTokenFreeBalance} MGR-TUR`}
                </div>
              </div>
          ...
          <Row>
            ...
            <div className="width-100">
              <div className="flex margin-bottom-24 width-100">
                <div className="margin-right-12 flex-grow-1">
                  <Image
                    src={imgMgx}
                    alt="MGX Token Icon"
                    width={24}
                ...
                <div className="flex-grow-10" style={{ lineHeight: '24px' }}>
                  MGR
                </div>
                <div className="flex-grow-1" style={{ lineHeight: '24px' }}>
                  {mgrFreeBalance}
                </div>
              </div>
